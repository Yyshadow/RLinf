...
case "${MODE}" in
    ...
    probe_strong)
        ...
        ;;
    probe_lq005_gc005)
        CONFIG_NAME="robotwin_beat_block_hammer_lwd_qam_openpi_pi05_probe_lq005_gc005"
        EXPERIMENT_NAME="robotwin_beat_block_hammer_lwd_qam_openpi_pi05_allstats_probe_lq005_gc005"
        MAX_STEPS=300
        SAVE_INTERVAL=100
        AUTO_RESUME=0
        ;;
